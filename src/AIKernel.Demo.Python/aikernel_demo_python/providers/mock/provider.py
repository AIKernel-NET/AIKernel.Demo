...
class MockProviderResponse:
    """[EN]
    Represents the MockProviderResponse public Python API surface.
    
    [JA]
    MockProviderResponse の公開 Python API サーフェスを表します。
    """
    output_hash: str
...
class MockProvider:
    """[EN]
    Represents the MockProvider public Python API surface.
    
    [JA]
    MockProvider の公開 Python API サーフェスを表します。
    """
    # EN: Public demo surface for readers. / JA: 読み手向けの公開 Demo サーフェスです。
    def generate(self, input_text: str | None) -> MockProviderResponse:
        ...
        Args:
            input_text: Input value for generate.
